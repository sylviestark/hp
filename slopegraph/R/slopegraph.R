...
#' collapsed with \code{\link{paste}}}, but equally spaced!
#'
...
#' @param lab.sep a numeric of length 1, only used if 'col.lab' is not of length 1 for the spacing of multiple labels on the same row (in the x-axis unit).
...
#' slopegraph(test, rescaleByColumn = F, col.line=test.col, cex.lab = 0.6, cex.num = 0.6, offset.x = 0.05, lab.sep = 0.2, xaxt = 's')
